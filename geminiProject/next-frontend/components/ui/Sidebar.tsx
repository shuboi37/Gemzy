            ...
            <div className="flex flex-1 flex-col items-center mt-5 w-16 relative">
              <div className="flex flex-col space-y-2 items-center h-[25%]">
                <button className="hover:bg-neutral-700 rounded-lg p-3">
                  <MessageSquarePlus className="flex-1 w-6 h-6 text-white transition-all ease-in-out duration-200" />
                </button>
                <button className="hover:bg-neutral-700 rounded-lg p-3">
                  <Search className="flex-1 w-6 h-6 text-white transition-all ease-in-out duration-200" />
                </button>
                <button className="hover:bg-neutral-700 rounded-lg p-3">
                  <Images className="flex-1 w-6 h-6 text-white transition-all ease-in-out duration-200" />
                </button>
              </div>
